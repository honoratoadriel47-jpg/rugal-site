...
export const PRODUCTS = [
  ...
  { id: "time-brasil-retro", name: "Camisa Brasil Retrô", category: "times", brand: "Nacional", price: 189.9, oldPrice: 269.9, image: IMG.jersey, gallery: gal(3, 4), tag: "Time", description: "Releitura retrô da seleção. Tecido dry premium com escudo bordado. Nacional de respeito." },
  { id: "time-europa-away", name: "Jersey Europa Away", category: "times", brand: "Internacional", price: 199.9, oldPrice: 289.9, image: IMG.jerseyLife, gallery: gal(4, 3), tag: "Time", description: "Camisa de time internacional versão away. Malha respirável com detalhes refletivos." },
